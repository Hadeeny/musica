...
const NowPlaying = () => {
    ...
    return (
        <section className="z-50 backdrop-blur-xl h-32 w-full fixed bottom-0 flex ">
            <div id='stub' className='w-11/12 flex justify-between items-center py-4 mx-auto'>
                <div className='flex gap-4 cursor-pointer items-center'>
                  <img width='60em' className='rounded-xl' src={cover11} alt='cover'/>
                  <div>
                    <div>{playing.title}</div>
                    <div>{playing.artist}</div>
                  </div>
                </div>
                <div className='h-14'>
                    <audio src={hotline} type='audio/mpeg'></audio>
                   <div className='flex justify-center gap-12'>
                       <BiShuffle className='cursor-pointer'/>
                       <GiNextButton className='cursor-pointer'/>
                       <BsFillPlayCircleFill className='cursor-pointer'/>
                       <GiPreviousButton className='cursor-pointer'/>
                   ...
                   <div className="bg-[#E6E6E6] mt-8 hidden cursor-pointer min-w-[40em] rounded-md h-[0.3em] lg:flex">
                       <div className="bg-yellow rounded-md cursor-pointer w-1/2 relative h-[0.4em]">
...
<path d="M10.515 2.83501C9.675 2.37001 8.6025 2.49001 7.5075 3.17251L5.3175 4.54501C5.1675 4.63501 4.995 4.68751 4.8225 4.68751H4.125H3.75C1.935 4.68751 0.9375 5.68501 0.9375 7.50001V10.5C0.9375 12.315 1.935 13.3125 3.75 13.3125H4.125H4.8225C4.995 13.3125 5.1675 13.365 5.3175 13.455L7.5075 14.8275C8.1675 15.24 8.8125 15.4425 9.4125 15.4425C9.8025 15.4425 10.1775 15.3525 10.515 15.165C11.3475 14.7 11.8125 13.7325 11.8125 12.4425V5.55751C11.8125 4.26751 11.3475 3.30001 10.515 2.83501Z" fill="#EFEEE0"/>
                ...
                <div className="bg-[#E6E6E6] hidden min-w-[10em] cursor-pointer rounded-md h-[0.3em] lg:block">
                       <div className="bg-yellow rounded-md w-1/2 relative h-[0.3em]">
                       </div>
                   </div>
                </div>
            </div>
