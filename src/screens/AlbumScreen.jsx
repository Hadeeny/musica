import tomorrow from "../assets/lead-image.png";
    ...
    <section className="overflow-x-hidden bg-cover bg-fixed bg-left bg-[url('../assets/Lead-image.png')] w-[90%] mt-[5em] mx-auto  lg:mb-24 gap-8 items-center">
      <div className="lg:flex gap-8 items-center">
        <div className="w-[22rem] lg:w-[15rem]">
          <img className="w-full" src={tomorrow} />
        </div>
        <div className="w-[25em] space-y-3">
          <h2 className="text-blue-300 text-3xl">Tomorrow's tunes</h2>
          <p className="text-md">
          ...
          <div className="flex gap-3">
            <div className="bg-[#323239] rounded-3xl py-2 flex gap-2 items-center px-3 cursor-pointer">
            ...
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4.51987 0.666973C4.93987 0.679746 5.34654 0.75308 5.74054 0.88708H5.77987C5.80654 0.899746 5.82654 0.913746 5.83987 0.926413C5.9872 0.973746 6.12654 1.02708 6.25987 1.10041L6.5132 1.21375C6.6132 1.26708 6.7332 1.36641 6.79987 1.40708C6.86654 1.44641 6.93987 1.48708 6.99987 1.53308C7.74054 0.96708 8.63987 0.660413 9.56654 0.666973C9.9872 0.666973 10.4072 0.726413 10.8065 0.860413C13.2672 1.66041 14.1539 4.36041 13.4132 6.72041C12.9932 7.92641 12.3065 9.02708 11.4072 9.92641C10.1199 11.1731 8.7072 12.2797 7.18654 13.2331L7.01987 13.3337L6.84654 13.2264C5.32054 12.2797 3.89987 11.1731 2.60054 9.91975C1.7072 9.02041 1.01987 7.92641 0.593202 6.72041C-0.160131 4.36041 0.726535 1.66041 3.21387 0.846413C3.4072 0.779746 3.60654 0.73308 3.80654 0.70708H3.88654C4.07387 0.679746 4.25987 0.666973 4.44654 0.666973H4.51987ZM10.4599 2.77375C10.1865 2.67975 9.88654 2.82708 9.78654 3.10708C9.6932 3.38708 9.83987 3.69375 10.1199 3.79308C10.5472 3.95308 10.8332 4.37375 10.8332 4.83975V4.86041C10.8205 5.01308 10.8665 5.16041 10.9599 5.27375C11.0532 5.38708 11.1932 5.45308 11.3399 5.46708C11.6132 5.45975 11.8465 5.24041 11.8665 4.95975V4.88041C11.8865 3.94641 11.3205 3.10041 10.4599 2.77375Z" fill="#E5524A"/>
            </svg>
            </div>
          </div>
        </div>
      ...
      <div className="mt-6 space-y-2">
        <div className="bg-[#25292C] flex justify-between items-center py-8 px-2 rounded-xl w-full h-14">
          <div className="flex gap-2 lg:gap-60 items-center">
            <div className='flex items-center gap-8'>
              <img width="50rem" src={cover4} />
            ...
            <div className="lg:flex lg:justify-between lg:w-96">
              <h3>Let me love you- Krisx</h3>
              <p>Single</p>
            </div>
          </div>
          <div className='lg:flex gap-52 items-center text-right'>
          <svg className='order-1 lg:order-2' width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.25789 7.58341C7.58006 7.58341 7.84123 7.32225 7.84123 7.00008C7.84123 6.67792 7.58006 6.41675 7.25789 6.41675C6.93573 6.41675 6.67456 6.67792 6.67456 7.00008C6.67456 7.32225 6.93573 7.58341 7.25789 7.58341Z" stroke="#FACD66" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M7.25789 3.49992C7.58006 3.49992 7.84123 3.23875 7.84123 2.91659C7.84123 2.59442 7.58006 2.33325 7.25789 2.33325C6.93573 2.33325 6.67456 2.59442 6.67456 2.91659C6.67456 3.23875 6.93573 3.49992 7.25789 3.49992Z" stroke="#FACD66" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M7.25789 11.6667C7.58006 11.6667 7.84123 11.4055 7.84123 11.0833C7.84123 10.7612 7.58006 10.5 7.25789 10.5C6.93573 10.5 6.67456 10.7612 6.67456 11.0833C6.67456 11.4055 6.93573 11.6667 7.25789 11.6667Z" stroke="#FACD66" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>

            <p className='order-2 lg:order-1 text-right'>4:17</p>
          </div>
        </div>
        <div className="bg-[#25292C] flex justify-between items-center py-8 px-2 rounded-xl w-full h-14">
          <div className="flex gap-2 lg:gap-80 items-center">
            <div>
              <img width="50rem" src={cover4} />
            </div>
            <div className="lg:flex lg:justify-between lg:w-96">
