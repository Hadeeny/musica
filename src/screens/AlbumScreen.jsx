...
const AlbumScreen = () => {
  ...
  return (
    <section className={`overflow-x-hidden bg-cover bg-fixed bg-left bg-[url(${newPlay[0].cover})] w-[90%] mt-[5em] mx-auto  lg:mb-24 gap-8 items-center`}>
        ...
        >
          <div className="flex gap-2 lg:gap-60 items-center">
            <div className="flex items-center gap-8">
              <img width="50rem" src={playlist.cover} />
              <svg
